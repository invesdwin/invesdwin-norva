...
<dependency>
	...
	<artifactId>invesdwin-common-norva</artifactId>
...
### Static Facade
```java
de.invesdwin.common.norva.apt.staticfacade.internal.StaticFacadeDefinitionAnnotationProcessor
```
...
### Constants
```java
de.invesdwin.common.norva.apt.constants.internal.ConstantsAnnotationProcessor
```
...
### Build Version
```java
de.invesdwin.common.norva.apt.buildversion.internal.BuildVersionDefinitionAnnotationProcessor
```
